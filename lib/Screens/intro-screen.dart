...
class _IntroScreenState extends State<IntroScreen> {
  final btnStyle = GoogleFonts.assistantTextTheme()
      .button
      .copyWith(color: Colors.black, fontSize: 17, letterSpacing: 1.1);
  ...
  void _donePressed() =>
      navigateAndPush(context: context, routeName: LoginScreen.routeName);
...
//            ),
            ...
            Text(
              screen.description,
              style: GoogleFonts.assistantTextTheme().display4.copyWith(
                  color: Colors.black, fontSize: 16, letterSpacing: 1.1),
  ...
  Widget build(BuildContext context) {
    return IntroductionScreen(
      ...
      skip: Container(
          ...
          child: Text("Skip", style: btnStyle)),
      showNextButton: true,
      next: Container(
        padding: const EdgeInsets.symmetric(vertical: 10.0),
